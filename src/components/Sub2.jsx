...
export default function Sub0(props) {
    ...
    for (let i = 0; i < usersPosted.length; i++) {
        for (let j = 0; j < usersPosted[i].posts.length; j++) {
            if (usersPosted[i].posts[j].subFrm === "Sub2") {
                onlySub2.push(usersPosted[i].posts[j]);
            }
        }
    }
    console.log("onlySub2", onlySub2)
                ...
                <div className="creater-container">
                    ...
                    <div className="flex justify-center">
                        <div>
                            ...
                            <h3>General Discussion Forum</h3>
                            <p className="subsection-info">This subsection is all discussing the ideas of 3D printing and drop shipping!</p>
                        </div>
                        <div>
                            <h3>Rules:</h3>
                            <ul>
