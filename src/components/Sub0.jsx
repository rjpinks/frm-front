...
export default function Sub0(props) {
    ...
    console.log("usersPosted", usersPosted);

    const onlySub0 = [];
    for (let i = 0; i < usersPosted.length; i++) {
        for (let j = 0; j < usersPosted[i].posts.length; j++) {
            if (usersPosted[i].posts[j].subFrm === "Sub0") {
                onlySub0.push(usersPosted[i].posts[j]);
            }
        }
    }
    console.log("onlySub0", onlySub0)
                ...
                <div className="creater-container">
                    ...
                    <div className="flex justify-center">
                        <div>
                            <div className="mb-4">
                                <h3>Buying Forum</h3>
                                <p className="subsection-info">This subsection is all about posting wanted ads!</p>
                            </div>
                            <div>
                                <h3>Rules:</h3>
                                <ul>
